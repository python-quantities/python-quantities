...
def test_hyperbolicfunctions():
    ...
    num_assert_almost_equal(
        q.sinh(a),
        numpy.sinh(numpy.array([1, 2, 3, 4, 6])) * q.dimensionless
    )
    ...
    num_assert_almost_equal(
        q.arcsinh(b),
        numpy.arcsinh(numpy.array([1, 2, 3, 4, 6])) * q.dimensionless
    )


    num_assert_almost_equal(
        q.cosh(a),
        numpy.cosh(numpy.array([1, 2, 3, 4, 6])) * q.dimensionless
    )

    num_assert_almost_equal(
        q.arccosh(b),
        numpy.arccosh(numpy.array([1, 2, 3, 4, 6])) * q.dimensionless
    )

    num_assert_almost_equal(
        q.tanh(a),
        numpy.tanh(numpy.array([1, 2, 3, 4, 6])) * q.dimensionless
    )

    c = [.01, .5, .6, .8, .99] * q.dimensionless
    num_assert_almost_equal(
        q.arctanh(c),
        numpy.arctanh(numpy.array([.01, .5, .6, .8, .99])) * q.dimensionless
    )
